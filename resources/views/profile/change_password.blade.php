                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label>Mot de passe actuel:</label><span
                        ...
                        <div class="form-group col-sm-12">
                            <label>Nouveau mot de passe:</label><span
                                class="required confirm-pwd"></span><span class="required">*</span>
                            <div class="input-group">
                        ...
                        <div class="form-group col-sm-12">
                            <label>Confirmez le mot de passe:</label><span
                                class="required confirm-pwd"></span><span class="required">*</span>
                            <div class="input-group">
                    ...
                    <div class="text-right">
                        ...
                        <button type="button" class="btn btn-light ml-1" data-dismiss="modal">Annuler
                        </button>
                    </div>
                </div>
            </form>
