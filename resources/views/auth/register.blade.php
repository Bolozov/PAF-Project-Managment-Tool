        ...
        <div class="card-body pt-1">
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="cin" class="control-label">Num. CIN :
                                :</label><span
                                class="text-danger">*</span>
                            <input id="cin" type="text"
                                   class="form-control{{ $errors->has('cin') ? ' is-invalid': '' }}"
                                   placeholder="Numéro Carte d'Identité Nationale" name="cin" tabindex="2" required>
                            <div class="invalid-feedback">
                                {{ $errors->first('cin') }}
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="num_tel"
                                   class="control-label">Numéro de téléphone:</label>
                            <input id="num_tel" type="tel" placeholder="Numéro de téléphone"
                                   class="form-control{{ $errors->has('num_tel') ? ' is-invalid': '' }}"
                                   name="num_tel" tabindex="2">
                            <div class="invalid-feedback">
